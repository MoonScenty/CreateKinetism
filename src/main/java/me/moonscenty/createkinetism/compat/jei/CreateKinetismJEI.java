...
public class CreateKinetismJEI implements IModPlugin {
	...
	public void registerCategories(IRecipeCategoryRegistration registration) {
		...
		categories.add(category("thermal_boiling", CKRecipeTypes.THERMAL_BOILING, 177, 103,
			CKBlocks.THERMAL_BOILER_TANK.get(), ThermalBoilingCategory::new, CKBlocks.THERMAL_BOILER_TANK.get(),
