 ...
 * because {@link ICogWheel} is what lets an adjacent cog drive the machine, and the Mechanical
 * Electrolyzer takes a shaft instead - see
 * {@link me.moonscenty.createkinetism.content.vat.MechanicalElectrolyzerBlock}. Leaving the marker on
