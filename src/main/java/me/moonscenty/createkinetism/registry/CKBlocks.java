...
public class CKBlocks {
	 ...
	 */
	public static final BlockEntry<MechanicalMetallurgicInfuserBlock> MECHANICAL_METALLURGIC_INFUSER = register(REGISTRATE
		.block("mechanical_metallurgic_infuser", MechanicalMetallurgicInfuserBlock::new)
	...
	// recoloured orange rather than a copy of Mekanism's art. See CKItems for the ingot/raw/nugget
	// items and c:ores|raw_materials|ingots|nuggets|storage_blocks/kinetite for the tags every
	// processing recipe keys off.

	public static final BlockEntry<Block> KINETITE_ORE = register(REGISTRATE
		.block("kinetite_ore", Block::new)
	...
	public static final BlockEntry<Block> DEEPSLATE_KINETITE_ORE = register(REGISTRATE
		.block("deepslate_kinetite_ore", Block::new)
	...
	public static final BlockEntry<Block> RAW_KINETITE_BLOCK = register(REGISTRATE
		.block("raw_kinetite_block", Block::new)
	...
	public static final BlockEntry<Block> KINETITE_BLOCK = register(REGISTRATE
		.block("kinetite_block", Block::new)
