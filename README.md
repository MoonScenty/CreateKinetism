...
> 사라진 레시피 때문에 여섯 개 기계가 지금 할 일이 없음 — 아래 「지금 멈춰 있는 것」 참고.
> 앞으로의 방향은 아직 정하지 않았음.
...
**남은 여섯도 갈림길은 같음.** Mekanism의 `Chemical`을 Create 파이프가 만질 유체로 건네주는
